...
@mcp.tool()
def execute_query(table_or_view_name: str, select_columns: list[str] = None, 
                 where_expr: str = None, order_by_column: str = None, 
                 order_asc: bool = True, limit: int = None) -> str:
